...
Find the Doxygen documentation generator's command-line tool.
...
``Doxygen::Doxygen``
  Target encapsulating the ``doxygen`` executable usage requirements.
...
``Doxygen_FOUND``
  Boolean indicating whether the ``doxygen`` executable was found.
...
``Doxygen_ROOT_DIR``, ``ENV{Doxygen_ROOT_DIR}``
  The root directory of a Doxygen installation where the executable is located.
  This can be used to specify a custom Doxygen installation path.
